pub const packages = struct {
    ...
    pub const @"N-V-__8AAEp9UgBJ2n1eks3_3YZk3GCO1XOENazWaCO7ggM2" = struct {
        pub const build_root = "/home/mrbeelo/.cache/zig/p/N-V-__8AAEp9UgBJ2n1eks3_3YZk3GCO1XOENazWaCO7ggM2";
        pub const deps: []const struct { []const u8, []const u8 } = &.{};
    };
    ...
    pub const @"raylib-5.5.0-whq8uExcNgQBBys4-PIIEqPuWO-MpfOJkwiM4Q1nLXVN" = struct {
        pub const build_root = "/home/mrbeelo/.cache/zig/p/raylib-5.5.0-whq8uExcNgQBBys4-PIIEqPuWO-MpfOJkwiM4Q1nLXVN";
    ...
    pub const @"raylib-zig" = struct {
        pub const build_root = "/home/mrbeelo/Desktop/Projects/BeeloRaylibZigTemplates/ZigBindingsRaylibTest/raylib-zig";
